...
const Menu = ({openMenu}) => {
    ...
    return (
        <div className={`font-vazirMedium w-[65%] md:w-1/3 h-full lg:hidden bg-white shadow-navbar fixed
        top-0 z-40 ${openMenu ? "duration-700 translate-y-0" : "duration-700 translate-x-[350px] li:translate-x-[500px] md:translate-x-[350px]"}`}>
                ...
                <ul className="text-li bg-white font-normal text-sm menu-mobile li:menu-mobile-li">
                    ...
                    <li>
                        ...
                        <div className="items-menu">
                            <ItemsMenu path="digital" item1="لوازم جانبی گوشی" item2="گوشی موبایل" item3="ساعت هوشمند" item4="اسپیکر بلوتوث و باسیم" item5="موبایل" />
                        </div>
                    </li>
                    ...
                    <div className={`absolute top-[72px] bg-white w-full items-menu-animate ${openList1 ? "translate-y-[158px] duration-500" : "translate-y-[0px] duration-500"}`}>
                        ...
                        <li>
                            ...
                            <div className="items-menu">
                                <ItemsMenu path="health" item1="لوازم آرایشی" item2="مراقبت پوست" item3="لوازم بهداشتی" item4="عطر و ادکلن" item5="لوازم شخصی برقی" />
                            </div>
                        </li>
                        ...
                        <div className={`absolute top-[30px] bg-white w-full items-menu-animate ${openList2 ? "translate-y-[158px] duration-500" : "translate-y-[0px] duration-500"}`}>
                            ...
                            <li>
                                ...
                                <div className={`items-menu`}>
                                    <ItemsMenu path="tool" item1="ابزار برقی" item2="ابزار غیربرقی" item3="حفاظتی و امنیتی" item4="خودرو" item5="موتور" />
                                </div>
                            </li>
            ...
            <span onClick={() => navigate(-1 , { replace : true })} className="link-back">بازگشت</span>
            <Link to="/" className="link-back-home">خانه</Link>
        </div>
    );
};
